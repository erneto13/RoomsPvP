...
import dev.erneto.config.Keys;
import dev.erneto.config.Lang;
import dev.erneto.hook.HookId;
import dev.erneto.selection.impl.CuboidSelection;
import dev.erneto.selection.impl.PositionSelection;
import dev.erneto.selection.impl.Selection;
import dev.erneto.selection.listener.SelectionListener;
import dev.erneto.selection.visual.BlockInfo;
import dev.erneto.selection.visual.Tracker;
import dev.erneto.selection.visual.highlight.BlockHighlighter;
import dev.erneto.selection.visual.highlight.BlockPacketsHighlighter;
import dev.erneto.selection.visual.highlight.BlockProtocolHighlighter;
import org.bukkit.*;
...
public class SelectionManager extends AbstractManager<RoomsPvP> {
    ...
    public SelectionManager(@NotNull RoomsPvP plugin) {
        super(plugin);
    ...
    public ItemStack getItem() {
        ...
        PDCUtil.set(itemStack, Keys.roomWand, true);
        return itemStack;
    }

    public boolean isItem(@NotNull ItemStack itemStack) {
        return PDCUtil.getBoolean(itemStack, Keys.roomWand).isPresent();
    }
