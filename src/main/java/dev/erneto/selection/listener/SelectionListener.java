package dev.erneto.selection.listener;
...
public class SelectionListener extends AbstractListener<RoomsPvP> {

    private final SelectionManager manager;

    public SelectionListener(@NotNull RoomsPvP plugin, @NotNull SelectionManager manager) {
        super(plugin);
